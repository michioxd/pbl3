...
{
    public interface IProvinceSearchService
    {
        Task<List<ProvinceResponse>> SearchAsync(string query);
    }

    public class ProvinceSearchService : IProvinceSearchService
    {
        private readonly ApplicationDbContext _context;

        public ProvinceSearchService(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<List<ProvinceResponse>> SearchAsync(string query)
        {
